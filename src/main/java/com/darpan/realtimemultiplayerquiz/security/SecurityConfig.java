    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Admin-only endpoints
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/quiz").hasRole("ADMIN")
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/question").hasRole("ADMIN")
